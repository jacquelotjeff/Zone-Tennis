...
<head>
	...
	{$HOOK_HEADER}
	<link rel="stylesheet"
		  href="http{if Tools::usingSecureMode()}s{/if}://fonts.googleapis.com/css?family=Open+Sans:300,600&amp;subset=latin,latin-ext"
	...
	<div class="header-container">
		<header id="header">
			...
			<div>
				<div class="container">
					<div class="row">
						<div id="header_logo" clas="col-xs-12 col-md-4">
							<h1>
		...
		<div id="columns" class="container">
			...
			<div id="slider_row" class="row">
				...
				{if $smarty.capture.displayTopColumn}
					<div id="top_column"
						 class="center_column col-xs-12 col-sm-12">{$smarty.capture.displayTopColumn}</div>
				{/if}
			</div>
			<div class="row">
